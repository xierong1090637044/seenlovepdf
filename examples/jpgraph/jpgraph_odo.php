...
class OdoNeedle  {
    ...
    function SetShadow($aShadow=true,$aColor="",$aDx=4,$aDy=4) {
    ...
    function Stroke($img,$aOdometer) {
        ...
        switch( $this->iStyle ) {
            ...
            case NEEDLE_STYLE_LARGE_TRIANGLE: // Triangle medium width base
                $base_width = isset($base_width)  ? $base_width : 20*4 ;
...
class Odometer {
    ...
    public $iStyle;
    public $label;
    private $iFillColor = "white", $iColor = "navy";
    private $iInd, $iIndIdx=0;
    private $iCenterAreaWidth = 0;
    private $iBase = true, $iBaseWidth=0.05;
    ...
    function FilledCircle1($img,$aXc,$aYc,$aRadius,$aFillColor) {
        $s = 0; $e = 360;
        $img->PushColor($aFillColor);
        $img->FilledArc($aXc,$aYc,$aRadius*2,$aRadius*2,$s,$e);
        $img->PopColor();
    ...
    function StrokeFascia($img) {
        ...
        if( $this->iBorderWidth > 1 ) {
            ...
            $this->FilledCircle($img,$this->xc,$this->yc,$r-$this->iBorderWidth,$this->iFillColor);
        }
        else {
        ...
        $this->FilledCircle1($img,$this->xc,$this->yc,$this->iCenterAreaWidth*$this->iRadius,$this->iFillColor);
    ...
    function Stroke($graph) {
        ...
        if( $this->iBase ) {
            ...
            $r = $r < 4 ? 4 : $r;
            $r2 = $r > 10 ? 2 : 1 ;
            $this->FilledCircle1($img,$this->xc,$this->yc,$r,$this->iBaseColor1);
            $this->FilledCircle1($img,$this->xc,$this->yc,$r-2,$this->iBaseColor2);
            $this->FilledCircle1($img,$this->xc,$this->yc,$r2+3,$this->iBaseColor3);
        }
    }
}
